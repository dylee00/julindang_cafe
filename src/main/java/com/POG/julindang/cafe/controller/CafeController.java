...
public class CafeController {
    ...
    public ResponseEntity<List<CafeDto>> findByCafeName(CafeFindDto cafeFindDto) throws CustomException {
    ...
    public ResponseEntity<List<CafeDto>> findByBeverageName(CafeFindDto cafeFindDto) throws CustomException {
    ...
    public ResponseEntity<CafeDto> findByCafeNameAndBeverageName(CafeFindDto cafeFindDto) throws CustomException {
    ...
    @PostMapping("/save")
    public ResponseEntity<CafeDto> save(CafeDto cafeDto) throws CustomException {
