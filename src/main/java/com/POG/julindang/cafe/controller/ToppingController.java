...
public class ToppingController {
    ...
    public ResponseEntity<List<ToppingResponseDto>> findAll(){
    ...
    public ResponseEntity<List<ToppingResponseDto>> findToppingsByCafeNameAndBeverageName(@RequestParam(name="cafeName", required = false) String cafeName,
